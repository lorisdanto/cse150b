...
from ai import AI
from test import test, test_extension
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == KEYDOWN:
                    ...
                    if event.key == K_e:
                        self.extension = not self.extension
    ...
    def print_matrix(self):
        ...
        for i in range(0, self.game.board_size):
            for j in range(0, self.game.board_size):
                ...
                if self.extension:
                    ext_lbl = self.scorefont.render("[Extension]", 1, BLACK, WHITE)
                    self.surface.blit(ext_lbl, EXTENSION_LABEL_POS)
